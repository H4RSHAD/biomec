...
from biomec.models.entidades.Laboratorista import Laboratorista


# importamos los controladores de Usuario
from ..controller import UserController,PersonaController, LaboratoristaController
    ...
    if request.method == "POST":
        ...
        if logged_user != None:         # Controlador de Usuario, si tienen datos
            ...
            if logged_user.password:    #si la contraseña coincide con el de la base de datos
                ...
                lista_id_rol =[1,2,3,4]
                lista_tipo = ['tipo.roles','tipo.personal','tipo.tecnico','tipo.personal'] 
